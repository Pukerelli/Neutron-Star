...
import {Btn} from "../../../../styles/StyledComponents/Buttons/CommonButtons.styledComponent";
...
export const UpdateCarPhoto: React.FC<IProps> = ({carName}) => {
    ...
    return (
        <MyCard boxShadow={true} width='100%' height='50vh'
            ...
            <ImgSimple onError={e => e.currentTarget.src = carDefaultImage} src={photo} height='80%' margin='1rem auto'/>
            <Btn onClick={submitHandler} top='89%'
