...
export const Garage: React.FC = () => {
    ...
    if (addCar) {
        return (
            <GridLayout width='100%' gridColumns='1fr 1fr 1fr' gridGap='1rem'>
                <AddCar/>
                <TrnsprntBtn height='2rem' width='10%' top='85%' color='#EB3649' onClick={onClick}>
    ...
    return (
        <>
            <TrnsprntBtn height='2rem' width='10%' top='10%' color='#EB3649' onClick={onClick}>
                {addCar ? 'cancel' : 'add car'}
            </TrnsprntBtn>

            <GridLayout width='80%' margin='0 auto'>
